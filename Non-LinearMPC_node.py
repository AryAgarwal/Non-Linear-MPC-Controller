...
from eufs_msgs.msg import MPC_metadata, MPC_trajectory, MPC_prediction
...
class MPCKinematicNode:
    def __init__(self):
        ...
        self.param = {'dT': rospy.get_param('dT', 0.2),
                      ...
                      'L': rospy.get_param('vehicle_L', 1.530),
                      ...
                      'INTEGRATION_MODE': rospy.get_param('integration_mode','RK4'), #can be 'RK4' or 'RK3'
                      'ipopt_verbose': rospy.get_param('ipopt_verbose', True)
                      }

        self.CENTER_TRACK_FILENAME = '/home/soham/mpcc_control_ws/src/nonlinear_mpc_casadi/scripts/generated_tracks/centerline_waypoints.csv'
        self.CENTER_DERIVATIVE_FILENAME = '/home/soham/mpcc_control_ws/src/nonlinear_mpc_casadi/scripts/generated_tracks/center_spline_derivatives.csv'
        self.RIGHT_TRACK_FILENAME = '/home/soham/mpcc_control_ws/src/nonlinear_mpc_casadi/scripts/generated_tracks/right_waypoints.csv'
        self.LEFT_TRACK_FILENAME = '/home/soham/mpcc_control_ws/src/nonlinear_mpc_casadi/scripts/generated_tracks/left_waypoints.csv'
        self.CONTROLLER_FREQ = rospy.get_param('controller_freq', 20)
        self.GOAL_THRESHOLD = rospy.get_param('goal_threshold', 0.75)
        self.CAR_WIDTH = rospy.get_param('car_width', 1)
        ...
        pose_topic = rospy.get_param('localized_pose_topic_name', '/gazebo/model_states')
        cmd_vel_topic = rospy.get_param('cmd_vel_topic_name', '/cmd_vel_out')
        odom_topic = rospy.get_param('odom_topic_name', '/ground_truth/odom')
        ...
        self.pub = rospy.Publisher("/cmd_vel_out", AckermannDriveStamped, queue_size=10)
        ...
        # Subscribers
        rospy.Subscriber(pose_topic, ModelStates, self.pf_pose_callback, queue_size=1)
        ...
        rospy.Subscriber(prediction_pub_topic, MPC_trajectory, self.traj_callback, queue_size=1)
    ...
    def pf_pose_callback(self, msg):
        ...
        self.current_pos_x = msg.pose[2].position.x
        self.current_pos_y = msg.pose[2].position.y
        self.current_yaw = self.quaternion_to_euler_yaw(msg.pose[2].orientation)
    ...
    def controlLoopCB(self, event):
        ...
        if 1<2:#self.goal_received and not self.goal_reached:
